...
class ControladorEntrada extends Controlador
{
    ...
    public function generarEntrada($ref)
    {
        ...
        if (isset($entrada)) {
            ...
            //un pequeño fix para rectificar casos como la foto de los Straits
            if(substr($datos["imagen"],0,4)!='img/') {
                $datos["imagen"]= 'img/'.$datos["imagen"];
            }

            //TODO: Añadir un fix para el formato de texto de los Straits.
